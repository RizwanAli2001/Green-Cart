...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
        ...
        {!user ? (
          ...
          <div className="relative group">
            ...
            <ul
              ...
              border-gray-200 py-2.5 w-30 rounded-md text-md text-sm z-40"
            >
              <li
      ...
      {/* Mobile Menu */}
      {open && (
        <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col items-start gap-2 px-5 text-sm sm:hidden">
          <NavLink to="/" onClick={() => setOpen(false)}>
            Home
          </NavLink>
